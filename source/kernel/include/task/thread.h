...
class ThreadBase : public ask::DListItem {
...
public:
	struct ListItem : public ask::DListItem {
		explicit ListItem(Thread *t) : ask::DListItem(), thread(t) {
		}
		Thread *thread;
	};
...
protected:
	...
	ask::ISList<frameno_t> reqFrames;
	Stats stats;

private:
	static ask::DList<ListItem> threads;
