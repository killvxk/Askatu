...
struct VMRegion : public ask::DListTreapNode<uintptr_t> {
    explicit VMRegion(Region *_reg,uintptr_t _virt)
    	: ask::DListTreapNode<uintptr_t>(_virt), fileuse(), reg(_reg) {
    }
...
class VMTree {
public:
	typedef ask::DListTreap<VMRegion>::iterator iterator;
	typedef ask::DListTreap<VMRegion>::const_iterator const_iterator;
