...
VESAScreen::VESAScreen(ask::Screen::Mode *minfo)
	...
	if(frmbuf == NULL)
		throw ask::default_error("Unable to map framebuffer",-ENOMEM);
...
VESAScreen *VESAScreen::request(ask::Screen::Mode *minfo) {
