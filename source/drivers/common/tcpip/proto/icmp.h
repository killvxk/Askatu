...
public:
	...
	static ssize_t sendEcho(const ask::Net::IPv4Addr &ip,const void *payload,size_t nbytes,
...
private:
	static ssize_t send(const ask::Net::IPv4Addr &ip,const void *payload,size_t nbytes,
