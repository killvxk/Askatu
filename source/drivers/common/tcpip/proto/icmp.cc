...
ssize_t ICMP::send(const ask::Net::IPv4Addr &ip,const void *payload,size_t nbytes,
	...
	icmp->checksum = 0;
	icmp->checksum = ask::Net::ipv4Checksum(reinterpret_cast<uint16_t*>(icmp),icmp->size() + nbytes);
