...
ssize_t TCP::send(const ask::Net::IPv4Addr &ip,ask::port_t srcp,ask::port_t dstp,uint8_t flags,
...
ssize_t TCP::sendWith(Ethernet<IPv4<TCP>> *pkt,const ask::Net::IPv4Addr &ip,ask::port_t srcp,
	...
	tcp->checksum = 0;
	tcp->checksum = ask::Net::ipv4PayloadChecksum(route.link->ip(),ip,IP_PROTO,
