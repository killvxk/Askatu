...
public:
	explicit RegularFile(ask::PathTreeItem<TarINode> *item,FILE *archive,int flags)
...
public:
	explicit DirFile(ask::PathTreeItem<TarINode> *item,ask::PathTree<TarINode> &tree)
