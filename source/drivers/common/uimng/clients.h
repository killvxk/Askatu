 ...
 */
class UIClient : public ask::Client {
public:
	...
	const ask::FrameBuffer *fb() const {
		return _fb;
	}
	/**
	 ...
	 */
	void setMode(int type,const ask::Screen::Mode &mode,ask::Screen *scr,const char *file,bool set);
