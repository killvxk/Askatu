...
public:
	 ...
	 */
	static bool find(int mid,ask::Screen::Mode *mode,ask::Screen **scr);
	 ...
	 * @param mode the mode
	 */
	static void adjustMode(ask::Screen::Mode *mode);
	 ...
	 */
	static ssize_t getModes(ask::Screen::Mode *modes,size_t n);

private:
	static std::vector<ask::Screen*> _screens;
};
