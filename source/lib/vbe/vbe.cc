...
static void vbet_drawCharLoop16(const ask::Screen::Mode &mode,uint8_t *pos,uint8_t c,uint8_t *fg,uint8_t *bg);
static void vbet_drawCharLoop24(const ask::Screen::Mode &mode,uint8_t *pos,uint8_t c,uint8_t *fg,uint8_t *bg);
static void vbet_drawCharLoop32(const ask::Screen::Mode &mode,uint8_t *pos,uint8_t c,uint8_t *fg,uint8_t *bg);
...
void vbet_drawChar(const ask::Screen::Mode &mode,uint8_t *frmbuf,gpos_t col,gpos_t row,uint8_t c,uint8_t color) {
