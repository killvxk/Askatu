...
class MoveFileCopy : public ask::FileCopy {
public:
...
int main(int argc,char *argv[]) {
	...
	uint flags = ask::FileCopy::FL_RECURSIVE;
	if(force)
		flags |= ask::FileCopy::FL_FORCE;
	if(progress)
		flags |= ask::FileCopy::FL_PROGRESS;
