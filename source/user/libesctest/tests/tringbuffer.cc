...
static void test_2() {
	...
	{
		ask::RingBuffer<size_t> rb(10,ask::RB_DEFAULT);
...
static void test_3() {
	...
	{
		ask::RingBuffer<size_t> rb(5,ask::RB_OVERWRITE);
...
static void test_4() {
	...
	{
		ask::RingBuffer<size_t> rb(5,ask::RB_DEFAULT);
...
static void test_5() {
	...
	{
		ask::RingBuffer<size_t> rb1(8,ask::RB_OVERWRITE);
		ask::RingBuffer<size_t> rb2(5,ask::RB_OVERWRITE);
