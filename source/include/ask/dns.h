...
public:
	 ...
	 * resolved, but only translated in an ask::Net::IPv4Addr object.
	 *
	 ...
	 */
	static ask::Net::IPv4Addr getHost(const char *name,uint timeout = 1000);
	 ...
	 * @throws if the operation failed
	 */
	static ask::Net::IPv4Addr resolve(const char *name,uint timeout = 1000);
...
private:
	...
	static ask::Net::IPv4Addr _nameserver;
};
