...
/**
 * Retrieves information about the file behind the given file-daskriptor
 *
...
/**
 * Retrieves only the size of the file referenced by the given file-daskriptor. This is only a
