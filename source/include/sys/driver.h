 ...
 * @return the file-dask if successfull, < 0 if an error occurred
 */
 ...
 * If a client wants to be served, the message is fetched from him and a file-daskriptor is returned.
 ...
 * @return the file-daskriptor for the communication with the client
 */
