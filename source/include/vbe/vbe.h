...
typedef uint8_t *(*fSetPixel)(const ask::Screen::Mode &mode,uint8_t *vidwork,uint8_t *color);
...
void vbet_drawChar(const ask::Screen::Mode &mode,uint8_t *frmbuf,gpos_t col,gpos_t row,
